...
entity myip_v1_1_S00_AXIS is
	...
	port (
        ...
        SRP : in integer;  --Read Pointer which directs to FIFO
        SEN : in std_logic; --ENABLE reading from FIFO
        SRX : out std_logic; --SIGNAL which shows that writing in FIFO finished
...
architecture arch_imp of myip_v1_1_S00_AXIS is
  ...
  --***************************************************************************************************************
	...
	signal stream_data_fifo : BYTE_FIFO_TYPE := (others=>(others=>'0')); --HERE IS OUR FIFO. AN ARRAY WITH DEPTH 64 AND WIDTH 32
	
	signal dout : std_logic_vector(31 downto 0);
	
	signal m_rp : integer :=0;
  --***************************************************************************************************************
begin
